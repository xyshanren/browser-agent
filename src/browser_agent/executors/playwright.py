...
class PlaywrightExecutor(BaseExecutor):
    ...
    def info_for_model(self) -> str:
        return (
            ...
            "Each observation includes a <dehydrated_dom> showing all interactive elements "
            "as a numbered tree with indentation for nesting. Use this text to understand "
            "what elements are available before finding them in the screenshot. "
            "Elements marked *[N] are newly appeared since your last action.\n\n"
            "You can also manage multiple tabs: use open_tab to open a URL in a new tab, "
            "switch_tab to switch between open tabs, close_tab to close a tab, "
            "and list_tabs to see all open tabs. Each tab has its own URL and page content. "
            "Switching tabs changes what you see in the screenshot.\n\n"
